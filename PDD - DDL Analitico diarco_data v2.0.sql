-- PDD / Capa analitica pesada - v2.0 - 2026-08-03
...
-- connexa_platform_ms.pdd; PostgreSQL no permite FK entre bases de datos.
...
'Detalle historico, explicable e inmutable de PDVB. Se publica un subconjunto compacto en connexa_platform_ms.pdd.';

COMMENT ON COLUMN datamart.dm_pdd_pdvb_estimate_detail.calculation_run_uuid IS
'Referencia logica, sin FK cross-database, a connexa_platform_ms.pdd.calculation_run.calculation_run_uuid.';

COMMENT ON TABLE datamart.dm_pdd_pdvb_backtest_detail IS
'Observaciones detalladas de rolling-origin backtest; las metricas agregadas se conservan en connexa_platform_ms.pdd.';
