    ...
    cases = [
        ...
        (
            "backtest/insert_backtest_detail.sql",
            {
                ...
                "forecast_calculation_run_uuid": None,
                "origin_cd": 41,
                "algo01_recent_weight": Decimal("0.80"),
                "algo01_previous_weight": Decimal("0.10"),
                "algo01_seasonal_weight": Decimal("0.20"),
                ...
                "actual_min_coverage": Decimal("0.70"),
                "croston_alpha": Decimal("0.10"),
                "adi_threshold": Decimal("1.32"),
                "cv2_threshold": Decimal("0.49"),
                "sample_percent": Decimal("100"),
                "history_recent_start": windows.recent_start,
                "history_recent_end": windows.recent_end,
                "history_previous_start": windows.previous_start,
                "history_previous_end": windows.previous_end,
                "history_seasonal_start": windows.seasonal_start,
                "history_seasonal_end": windows.seasonal_end,
                "actual_window_start": date(2026, 8, 1),
            },
        ),
        (
