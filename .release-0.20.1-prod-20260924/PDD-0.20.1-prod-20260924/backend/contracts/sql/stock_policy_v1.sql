...
CREATE TABLE supply_planning.spl_stock_policy_version (
 id uuid PRIMARY KEY,
...
CREATE TABLE supply_planning.spl_stock_purchase_classification (
 code integer PRIMARY KEY,
 name text NOT NULL
);

CREATE TABLE supply_planning.spl_stock_policy_rule (
 id uuid PRIMARY KEY,
...
CREATE TABLE supply_planning.spl_stock_policy_import_row (
 policy_version_id uuid NOT NULL REFERENCES supply_planning.spl_stock_policy_version(id),
