...
ALTER TABLE stock_management.pdd_pdvb_backtest_metric
    ...
    DROP CONSTRAINT ck_pdd_pdvb_backtest_estimator,
...
ALTER TABLE stock_management.pdd_pdvb_backtest_metric
    ...
    ADD CONSTRAINT ck_pdd_pdvb_backtest_evaluation_mode CHECK (
...
COMMENT ON COLUMN stock_management.pdd_pdvb_backtest_metric.evaluation_mode IS
